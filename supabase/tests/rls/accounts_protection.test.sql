...
\set user_onboarding 'd3333333-3333-3333-3333-333333333333'
...
select throws_ok(
  $$ update public.accounts set status = 'active' where auth_user_id = 'd3333333-3333-3333-3333-333333333333'::uuid $$,
  '42501',
