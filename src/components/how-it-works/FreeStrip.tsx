...
const freeSteps = [
  "Set up your profile and intent",
  "Browse recommended gamers",
  "Connect and message privately",
  "Send play invitations",
  "Build one private group",
];
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-10 px-5 sm:px-8 lg:grid-cols-[1fr_0.9fr]">
        <div className="reveal">
          ...
          <h2 className="mt-3 max-w-xl font-[family-name:var(--font-display)] text-3xl leading-tight font-bold tracking-[-0.03em] text-[var(--color-night-navy)] sm:text-4xl">
            Every step you just saw is free.
          </h2>
          <p className="mt-5 max-w-xl text-lg leading-8 text-[var(--color-text-slate)]">
            Discovery, connections, private messaging, play invitations, and
            one private group are all included with SameLobby Free. Plus adds
            organization tools — never visibility, ranking, or safety.
          </p>
